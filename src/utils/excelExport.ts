...
export const generateEditableTemplate = (
  ...
  const dashboardData: any[][] = [
    ...
    ['Ajuste NDF Dólar', { f: `(B10-B8)*B18` }, '', 'R$'],
    ...
    ['Faturamento Total', { f: `B16-(B17*B19)` }, 'Venda - Ajustes', 'Receita final esperada'],
    ['Lucro Total', { f: `B25-B20` }, 'Faturamento - Custo Op.', 'Resultado líquido operacional'],
    ['Valor por Saca', { f: `B25/B15` }, 'Faturamento / Qtd Sacas', 'Preço médio realizado'],
    ...
    ['ROI (%)', { f: `(B26/B20)*100` }, '(Lucro / Custo) x 100', 'Retorno sobre investimento'],
    ['', '', '', ''],
    ['RESUMO VISUAL', '', '', ''],
    ['KPI', 'Status', '', ''],
  ...
  if (scenarios.length > 0) {
    ...
    scenarios.forEach((scenario, index) => {
      ...
      cenariosData.push([
        ...
        scenario.dolarPtax,
        {
          f: `(D${rowNum}*'Informações de Hedge'!B15)-((('Informações de Hedge'!B8-C${rowNum})*'Informações de Hedge'!B10)*('Informações de Hedge'!B6-E${rowNum})*'Informações de Hedge'!B14)`,
        },
        { f: `F${rowNum}-'Planilha de Custos'!D28` },
        { f: `F${rowNum}/'Informações de Hedge'!B15` },
